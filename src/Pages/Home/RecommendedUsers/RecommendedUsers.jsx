...
const RecommendedUsers = () => {
  const linkData = [
    ...
    { id: 2, link: "/help", title: "Help" },
    { id: 3, link: "/press", title: "Press" },
    { id: 4, link: "/api", title: "API" },
    { id: 5, link: "/jobs", title: "Jobs" },
    { id: 6, link: "/privacy", title: "Privacy" },
    { id: 7, link: "/terms", title: "Terms" },
    { id: 8, link: "/locations", title: "Locations" },
    { id: 9, link: "/language", title: "Language" },
    { id: 10, link: "/meta", title: "Meta Verified" },
  ];
        ...
        <div className="w-full h-auto my-8">
          ...
          {recommendedUserData.map((user) => (
            ...
            >
              <Link
                to="/profile"
                className="w-full h-auto flex item-center gap-x-2"
              >
                <img
                  src={user.profileImg}
                  alt={user.username}
        ...
        <div className="w-full h-auto">
          <div className="w-full h-auto flex items-center gap-x-[4px] flex-wrap mb-3">
            {linkData.map((data) => (
              <div
                key={data.id}
                className="w-fit h-auto flex items-center gap-x-[3px]"
              >
                <Link
                  to={data.link}
                  className="text-[0.75rem] font-normal  text-[#5b5b5b] hover:underline"
                >
                  {data.title}
                </Link>
                <div className="w-[2px] h-[2px] bg-[#5b5b5b] rounded-full"></div>
              </div>
            ))}
          </div>
          <p className="text-xs text-[#5b5b5b] font-normal">
